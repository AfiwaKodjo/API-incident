    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(POST, "/api/incidents/**").hasAnyAuthority(ADMIN_CREATE.name(), RESPONSABLE_CREATE.name())
                        .requestMatchers(PUT, "/api/incidents/**").hasAnyAuthority(ADMIN_UPDATE.name(), RESPONSABLE_UPDATE.name())
                        .requestMatchers(DELETE, "/api/incidents/**").hasAnyAuthority(ADMIN_DELETE.name(), RESPONSABLE_DELETE.name())
                        ...
                        .requestMatchers(POST, "/api/materiels/**").hasAnyAuthority(ADMIN_CREATE.name(), RESPONSABLE_CREATE.name())
